...
@Entity
public class SujeitoMongo implements Serializable {
    ...
    public SujeitoMongo(long id, boolean isMasculino, int idade, String grupoSanguineo, String sintomas, boolean intervencao, boolean obito) {
        this.id = id;
